...
def runAutonomousControls(zed):
    ...
    pygame.draw.line(window, (0,0,255), path.coordinateTransform(0, 0), path.coordinateTransform(end_pos_x, end_pos_y), width=ROBOT_WIDTH)
...
while True:
    ...
    lines = Path()
    window.fill((255, 255, 255))
    pygame.draw.circle(window, (0,0,0), lines.coordinateTransform(0, 0), 20) #Draw a black circle representing the robot in the overhead view
    #drawing grid lines
    pygame.draw.line(window, (0,0,0), lines.coordinateTransform(0, 0), lines.coordinateTransform(0, 600), width=2)
    pygame.draw.line(window, (0,0,0), lines.coordinateTransform(100, 0), lines.coordinateTransform(100, 600), width=2)
    pygame.draw.line(window, (0,0,0), lines.coordinateTransform(200, 0), lines.coordinateTransform(200, 600), width=2)
    pygame.draw.line(window, (0,0,0), lines.coordinateTransform(-100, 0), lines.coordinateTransform(-100, 600), width=2)
    pygame.draw.line(window, (0,0,0), lines.coordinateTransform(-200, 0), lines.coordinateTransform(-200, 600), width=2)

    #Add horizontal grid lines
    pygame.draw.line(window, (0,0,0), lines.coordinateTransform(-300, 100), lines.coordinateTransform(300, 100), width=2)
    pygame.draw.line(window, (0,0,0), lines.coordinateTransform(-300, 200), lines.coordinateTransform(300, 200), width=2)
    pygame.draw.line(window, (0,0,0), lines.coordinateTransform(-300, 300), lines.coordinateTransform(300, 300), width=2)
    pygame.draw.line(window, (0,0,0), lines.coordinateTransform(-300, 400), lines.coordinateTransform(300, 400), width=2)
    pygame.draw.line(window, (0,0,0), lines.coordinateTransform(-300, 500), lines.coordinateTransform(300, 500), width=2)
